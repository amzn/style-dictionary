 ...
 * @param {String} transform.name - Name of the transformer by which a transformGroup can call a list of transforms.
 ...
 * @param {Function} transform.transformer Performs a transform on a property object, should return a string or object depending on the type. You can't mess up property objects on accident as it will only update certain properties.
