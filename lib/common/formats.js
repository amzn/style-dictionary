...
function formattedVariables(format, dictionary, keepReferences = false) {
  ...
  return dictionary.allProperties
    ...
    // before it is used. If `keepReferences` is true, check if the token
    ...
    .map(function(prop) {
      ...
      if (keepReferences && dictionary.usesReference(prop.original.value)) {
...
module.exports = {
   ...
   * ```
   */
  'css/variables': function(dictionary, config = {}, file = {}) {
    const { options = {} } = file;
    return fileHeader(options.showFileHeader) +
      ':root {\n' +
      formattedVariables('css', dictionary, options.keepReferences) +
      '\n}\n';
  },
  ...
  'scss/variables': function(dictionary, config = {}, file = {}) {
    ...
    return fileHeader(options.showFileHeader, 'short') +
      formattedVariables('sass', dictionary, options.keepReferences);
  },
   ...
   * ```
   */
  'scss/icons': function(dictionary, config, file) {
    const { options = {} } = file;
    return fileHeader(options.showFileHeader, 'short') + iconsWithPrefix('$', dictionary.allProperties, config, 'short');
  },
  ...
  'less/variables': function(dictionary, config, file) {
    const { options = {} } = file;
    return fileHeader(options.showFileHeader, 'short') +
      formattedVariables('less', dictionary, options.keepReferences);
  },
   ...
   * ```
   */
  'less/icons': function(dictionary, config, file) {
    const { options = {} } = file;
    return fileHeader(options.showFileHeader, 'short') + iconsWithPrefix('@', dictionary.allProperties, config, 'short');
  },
   ...
   * ```
   */
  'javascript/module': function(dictionary, config, file) {
    return fileHeader(file.options) +
    'module.exports = ' +
   ...
   * ```
   */
  'javascript/object': function(dictionary, config, file) {
    return  fileHeader(file.options) +
      'var ' +
   ...
   * ```
   */
  'javascript/umd': function(dictionary, config, file) {
   ...
   * ```
   */
  'javascript/es6': function(dictionary, config, file) {
    return fileHeader(file.options) +
   ...
   * ```
   */
  'android/resources': function(dictionary, platform, file) {
    const template = _.template(
      fs.readFileSync(__dirname + '/templates/android/resources.template')
    );
    return template({dictionary, file});
  },
