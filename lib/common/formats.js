...
const formats = {
   ...
   * ```
   */
  'javascript/es6-module': async function ({ dictionary, file, options }) {
    ...
    const dictionaryString = minify
      ? JSON.stringify(minifyDictionary(dictionary.tokens, options.usesDtcg), null, 2)
      : JSON.stringify(dictionary.tokens, null, 2);
