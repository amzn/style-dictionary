...
const { fileHeader, formattedVariables, iconsWithPrefix, minifyDictionary, createPropertyFormatter, sortByName, sortByReference } = require('./formatHelpers');
...
// Mark which formats are deprecated
module.exports['sass/map-deep'].deprecationMessage = `'sass/map-deep' is deprecated, please use 'scss/map-deep'`;
module.exports['sass/map-flat'].deprecationMessage = `'sass/map-flat' is deprecated, please use 'scss/map-flat'`;