...
function formattedVariables(format, dictionary, useVariables = false) {
  ...
  return dictionary.allProperties.map(function(prop) {
      ...
      if (useVariables && dictionary.usesReference(prop.original.value)) {
...
module.exports = {
  ...
  'css/variables': function(dictionary, config = {}, file = {}) {
    return fileHeader(file.options) +
      ':root {\n' +
      formattedVariables('css', dictionary, file.useVariables) +
      '\n}\n';
  },
  ...
  'scss/variables': function(dictionary, config = {}, file = {}) {
    return fileHeader(this.options, 'short') +
      formattedVariables('sass', dictionary, file.useVariables);
  },
  ...
  'scss/icons': function(dictionary, config, file) {
    return fileHeader(file.options, 'short') + iconsWithPrefix('$', dictionary.allProperties, config, 'short');
  },
  ...
  'less/variables': function(dictionary, config, file) {
    return fileHeader(this.options, 'short') +
      formattedVariables('less', dictionary, file.useVariables);
  },
  ...
  'android/resources': function(dictionary, platform, file) {
    ...
    return template(Object.assign({}, dictionary, file));
  },
