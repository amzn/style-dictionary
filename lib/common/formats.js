...
module.exports = {
  ...
  /**
   * Creates a Swift implementation file of a color class
   *
   * @memberof Formats
   * @kind member
   * @todo Add example and usage
   */
  'ios-swift/colors.swift': _.template(
    fs.readFileSync(__dirname + '/templates/ios-swift/colors.swift.template')
  ),
  // Css templates
