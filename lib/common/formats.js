...
module.exports = {
  ...
  /**
   * Creates a Swift implementation file of an enum of values
   *
   * @memberof Formats
   * @kind member
   * @todo Add example and usage
   */
  'ios-swift/size.swift': _.template(
    fs.readFileSync(__dirname + '/templates/ios-swift/size.swift.template')
  ),
   ...
   * @todo Add example and usage
   */
  'ios-swift/static.swift': _.template(
    fs.readFileSync(__dirname + '/templates/ios-swift/static.swift.template')
  ),
