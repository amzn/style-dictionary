...
module.exports = {
   ...
   * @param {Boolean} [options.outputReferences=false] - Whether or not to keep references (a -> b -> c) in the output.
   * @example
   * ```css
   * :root {
   ...
   * ```
   */
  'ios-swift/class.swift': function(dictionary, platform, file) {
    const template = _.template(
   ...
   * ```
   */
  'flutter/class.dart': function(dictionary, platform, file) {
    const template = _.template(
