 ...
 * @typedef {import('../../../types/File.js').FileHeader} FileHeader
 * @typedef {import('../../../types/File.js').FormattingOptions} Formatting
 */
 ...
 * @param {'short' | 'xml'} [options.commentStyle] - The only options are 'short' and 'xml', which will use the // or \<!-- --> style comments respectively. Anything else will use \/\* style comments.
