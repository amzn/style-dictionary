...
var indexTemplate = _.template(fs.readFileSync(__dirname + '/templates/static-style-guide/index.html.template'));
var recursivePropertyTemplate = _.template(fs.readFileSync(__dirname + '/templates/static-style-guide/recursiveProperty.template'));
var recursivePropertyTemplateMatchSyntax = function (modelData) {
  return recursivePropertyTemplate({model:modelData, recursivePropertyTemplate:recursivePropertyTemplateMatchSyntax});
};
...
module.exports = {
  ...
  'static-style-guide/index.html': function (modelData) {
    return indexTemplate({model:modelData, recursivePropertyTemplate:recursivePropertyTemplateMatchSyntax});
  }
};
