...
var convertToBase64 = require('../utils/convertToBase64');
...
module.exports = {
  ...
  'name/ti/constant': {
    ...
    transformer(prop, { prefix }) {
      ...
      return _.snakeCase([prefix].concat(path).join(' ')).toUpperCase();
    },
  },
