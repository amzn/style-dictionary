...
module.exports = {
   ...
   * @memberof TransformGroups
   */
  scss: ['attribute/cti', 'name/cti/kebab', 'time/seconds', 'content/icon', 'size/rem', 'color/css'],
   ...
   * @memberof TransformGroups
   */
  css: ['attribute/cti', 'name/cti/kebab', 'time/seconds', 'content/icon', 'size/rem', 'color/css'],
   ...
   * @memberof TransformGroups
   */
  less: ['attribute/cti', 'name/cti/kebab', 'time/seconds', 'content/icon', 'size/rem', 'color/hex'],
