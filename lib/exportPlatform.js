...
var PROPERTY_REFERENCE_ERRORS = GroupErrors.GROUP.PropertyReferenceErrors;
...
function exportPlatform(platform) {
  ...
  if(GroupErrors.count(PROPERTY_REFERENCE_ERRORS) > 0) {
    GroupErrors.flush(PROPERTY_REFERENCE_ERRORS);
