...
var current_context = []; // To maintain the context and eventually we can test for circular definitions
var defaults = {
  opening_character: '{',
  closing_character: '}',
  separator: '.',
      ...
      if (typeof ref === 'string') {
        ...
        if ( to_ret.indexOf('{') > -1 ) {
          ...
          if (foundCirc.hasOwnProperty(reference)) {
            ...
            // chop down to the circular part, save it to our circular reference info, and spit out an error
