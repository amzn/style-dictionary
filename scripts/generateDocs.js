...
fs.writeFileSync(
  TRANSFORMS_PATH,
  prependWarning(transforms, 'scripts/handlebars/templates/transforms.hbs')
);
...
fs.writeFileSync(
  ...
  prependWarning(transform_groups, 'scripts/handlebars/templates/transform_groups.hbs')
);
...
fs.writeFileSync(
  ACTIONS_PATH,
  prependWarning(actions, 'scripts/handlebars/templates/actions.hbs')
);
...
fs.writeFileSync(
  FORMATS_PATH,
  prependWarning(formats, 'scripts/handlebars/templates/formats.hbs')
);
