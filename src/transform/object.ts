...
import transformToken from './token';
import tokenSetup from './tokenSetup';
import type { TransformedTokens, Config, Volume, TransformedPlatformConfig } from '../types';
...
export default async function transformObject(
  ...
  }: { transformedPropRefs?: string[]; deferredPropValueTransforms?: string[] } = {},
  path: string[] = [],
  transformedObj: TransformedTokens = {},
  volume: Volume,
) {
