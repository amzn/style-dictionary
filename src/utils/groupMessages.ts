...
export class GroupMessages {
  private groupedMessages: Record<string, string[]>;
   ...
   */
  add(messageGroup: string, message: string) {
    if (messageGroup) {
   ...
   * @param {string} message
   */
  remove(messageGroup: string, message: string) {
   ...
   * @returns {string[]}
   */
  fetchMessages(messageGroup: string) {
