...
import type { GetReferencesOptions } from '../../types/Config';
...
export function getReferences(
  ...
  opts: GetReferencesOptions & { unfilteredTokens?: TransformedTokens } = {},
  references: TransformedToken[] = [],
) {
   ...
   */
  function findReference(match: string, variable: string) {
    ...
    if (ref !== undefined) {
      references.push({ ...(ref as TransformedToken), ref: pathName });
