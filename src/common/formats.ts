...
} from './formatHelpers/index';

import androidColors from './templates/android/colors.template';
import androidDimens from './templates/android/dimens.template';
import androidFontDimens from './templates/android/fontDimens.template';
import androidIntegers from './templates/android/integers.template';
import androidResources from './templates/android/resources.template';
import androidStrings from './templates/android/strings.template';
import composeObject from './templates/compose/object.kt.template';
import cssFonts from './templates/css/fonts.css.template';
import flutterClassDart from './templates/flutter/class.dart.template';
import iosColorsH from './templates/ios/colors.h.template';
import iosColorsM from './templates/ios/colors.m.template';
import iosSingletonH from './templates/ios/singleton.h.template';
import iosSingletonM from './templates/ios/singleton.m.template';
import iosStaticH from './templates/ios/static.h.template';
import iosStaticM from './templates/ios/static.m.template';
import iosStringsH from './templates/ios/strings.h.template';
import iosStringsM from './templates/ios/strings.m.template';
import iosSwiftAny from './templates/ios-swift/any.swift.template';
import scssMapDeep from './templates/scss/map-deep.template';
import scssMapFlat from './templates/scss/map-flat.template';
import macrosTemplate from './templates/ios/macros.template';
import plistTemplate from './templates/ios/plist.template';
import type { Format, FormattingOptions, TransformedTokens } from '../types';
 ...
 */
function getFormattingCloneWithoutPrefix(formatting?: FormattingOptions) {
 ...
 */
const formats: Record<string, Format['format']> = {
  /**
  ...
  'typescript/module-declarations': async function ({ dictionary, file, options }) {
     ...
     * @returns
     */
    function treeWalker(obj: TransformedTokens) {
