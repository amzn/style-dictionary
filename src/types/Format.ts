...
import type { Dictionary, TransformedToken } from './DesignToken';
import type { File } from './File';
import type { LocalOptions, Config, PlatformConfig } from './Config';
...
export type InternalFnArguments<T = unknown> = FormatFnArguments & {
  header?: string;
} & T;

export type InternalFormatFn<T = unknown> = (args: InternalFnArguments<T>) => string;
