...
import type { DesignToken, DesignTokens } from './DesignToken';
import type { Filter } from './Filter';
import type { FileHeader, File, FormattingOptions, TransformedFile } from './File';
import type { Parser } from './Parser';
import type { Preprocessor } from './Preprocessor';
import type { Transform } from './Transform';
import type { Format, OutputReferences } from './Format';
...
export interface TransformedPlatformConfig extends PlatformConfig {
  transforms?: Omit<Transform, 'name'>[];
  actions?: Omit<Action, 'name'>[];
