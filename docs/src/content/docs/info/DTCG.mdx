...
**As of version 4**, Style Dictionary has first-class support for this format.
...
- ✅ Moves `$type` properties from individual design tokens to the uppermost common ancestor token group
