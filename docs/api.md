...
as actions run after the files in a platform are generated.
...
| transform.name | <code>String</code> | Name of the transformer by which a transformGroup can call a list of transforms. |
