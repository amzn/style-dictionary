...
describe("buildPlatform", () => {
  ...
  it("should build web platform files", () => {
    StyleDictionaryExtended.buildPlatform("web");
    expect(
      helpers.fileExists("./__tests__/__output/web/_icons.css")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/web/_styles.js")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/web/_variables.css")
    ).toBeTruthy();
  });
  ...
  it("should build scss platform files", () => {
    ...
    expect(
      helpers.fileExists("./__tests__/__output/scss/_icons.scss")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/scss/_variables.scss")
    ).toBeTruthy();
  });
  ...
  it("should build less platform files", () => {
    ...
    expect(
      helpers.fileExists("./__tests__/__output/less/_icons.less")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/less/_variables.less")
    ).toBeTruthy();
  });
  ...
  it("should do android stuff", () => {
    ...
    expect(
      helpers.fileExists("./__tests__/__output/android/colors.xml")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/android/dimens.xml")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/android/font_dimen.xml")
    ).toBeTruthy();
  });
  ...
  it("should do ios stuff", () => {
    ...
    expect(
      helpers.fileExists("./__tests__/__output/ios/style_dictionary.plist")
    ).toBeTruthy();
    expect(
      helpers.fileExists("./__tests__/__output/ios/style_dictionary.h")
    ).toBeTruthy();
  });
