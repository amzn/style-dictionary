...
var config = helpers.fileToJSON(__dirname + '/__configs/test_buildPlatform.json');
...
describe('buildPlatform', () => {
  ...
  beforeEach(() => {
    helpers.clearOutput('__tests__/__output/__buildPlatform/');
  });
  ...
  it('should build scss platform files', () => {
    ...
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/scss/_icons.scss')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/scss/_variables.scss')).toBeTruthy();
  });

  it('should build less platform files', () => {
    StyleDictionaryExtended.buildPlatform('less');
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/less/_icons.less')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/less/_variables.less')).toBeTruthy();
  });

  it('should do android stuff', () => {
    StyleDictionaryExtended.buildPlatform('android');
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/android/main/res/drawable-hdpi/flag_us.png')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/android/main/res/drawable-xhdpi/flag_us.png')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/android/colors.xml')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/android/dimens.xml')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/android/font_dimen.xml')).toBeTruthy();
  });

  it('should do ios stuff', () => {
    StyleDictionaryExtended.buildPlatform('ios');
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/ios/style_dictionary.plist')).toBeTruthy();
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/ios/style_dictionary.h')).toBeTruthy();
  });
  ...
  it('should handle non-string values in properties', () => {
    var StyleDictionaryExtended = StyleDictionary.extend({
      ...
      platforms: {
        test: {
          buildPath: "__tests__/__output/__buildPlatform/",
    ...
    expect(helpers.fileExists('./__tests__/__output/__buildPlatform/output.json')).toBeTruthy();
    // var input = helpers.fileToJSON('./__tests__/__properties/nonString.json');
    var output = helpers.fileToJSON('./__tests__/__output/__buildPlatform/output.json');
    ...
    var StyleDictionaryExtended = StyleDictionary.extend({
      ...
      platforms: {
        foo: {
          transformGroup: 'bar',
          files: [{
            destination: '__tests__/__output/__buildPlatform/test.css',
