...
var expect = require('chai').expect, helpers = require('./helpers'), flattenProperties = require("../lib/utils/flattenProperties"), filterProperties = require('../lib/filterProperties');
