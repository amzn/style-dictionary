  ...
  describe('resolveObject', () => {
    ...
    it('should do simple interpolation for both strings and numbers', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/interpolation.json'),
      );
    ...
    it('should handle nested pointers', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/nested_pointers.json'),
      );
    ...
    it('should handle deep nested pointers', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/nested_pointers_2.json'),
      );
    ...
    it('should handle deep nested pointers with string interpolation', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/nested_pointers_3.json'),
      );
    ...
    it('should handle deep nested pointers and nested references', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/nested_pointers_4.json'),
      );
    ...
    it('should keep the type of the referenced property', () => {
      var test = resolveObject(
        helpers.fileToJSON(__dirname + '/../__json_files/reference_type.json'),
      );
      expect(test).toHaveProperty('d', 1);
    ...
    it('should gracefully handle basic circular references', () => {
      ...
      expect(JSON.stringify(GroupMessages.fetchMessages(PROPERTY_REFERENCE_WARNINGS))).toBe(
