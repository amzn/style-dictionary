...
describe('buildFile', () => {
  ...
  it('should error if format doesnt exist or isnt a function', () => {
    expect(buildFile.bind(null, { destination: '__tests__/__output/test.txt' }, {}, {})).toThrow(
  ...
  it('should error if destination doesnt exist or isnt a string', () => {
    expect(buildFile.bind(null, { format }, {}, {})).toThrow('Please enter a valid destination');
  ...
  describe('name collisions', () => {
    ...
    it('should generate warning messages for output name collisions', () => {
      ...
      expect(JSON.stringify(GroupMessages.fetchMessages(PROPERTY_NAME_COLLISION_WARNINGS))).toBe(
        expectJSON,
      );
    });
