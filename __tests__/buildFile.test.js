...
describe('buildFile', () => {
  ...
  describe('name collisions', () => {
    ...
    it('should generate errors for output name collisions when file-level options.log=error', () => {
      GroupMessages.clear(PROPERTY_NAME_COLLISION_WARNINGS);
      expect(() => {
        buildFile({destination, format, options: {log: 'error'}}, {}, properties);
      }).toThrow('Property name collision')
