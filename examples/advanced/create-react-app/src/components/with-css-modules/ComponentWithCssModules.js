    ...
    return (
      <div className={styles['component']}>
          ...
          <div className={styles['component-text']}>
            ...
            <p className={styles['component-text__reference']}>More information about CSS Modules: <a className={styles['component-link']} href="https://github.com/css-modules/css-modules" target="_blank" rel="noopener noreferrer">github.com/css-modules/css-modules</a></p>
          </div>
      </div>
    );
  }
