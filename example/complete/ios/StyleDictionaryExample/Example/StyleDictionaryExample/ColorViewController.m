...
- (void)baseColorAction:(id)sender {
    BaseColorViewController *nextController = [[BaseColorViewController alloc] init];
    [[self navigationController] pushViewController:nextController animated:YES];
}


- (void)textColorAction:(id)sender {
    TextColorViewController *nextController = [[TextColorViewController alloc] init];
    [[self navigationController] pushViewController:nextController animated:YES];
}
...
- (void)linkAction:(StyleDictionaryButton *)sender {
    ...
    Class c = array[index];
    id nextController = [[c alloc] init];
    [[self navigationController] pushViewController:nextController animated:YES];
}
